Program for consistency check: output for new dataset of Adopted Levels, Gammas with all data (version 05/20/2025)
Generated at: Tue 06/10/2025 at 10:16:04 PM EDT                                 
 ...
 35SI c  2007Ne14: {+35}Si g.s. magnetic moment and {Ig}-factor using |b-NMR.   
 ...
 35SI cG E(A,B),RI(A)$From {+9}Be({+36}Si,{+35}Si|g)                            
 35SI cL E$From a least-squares fit to |g-ray energies if applicable. Values    
 35SI2cL without uncertainties are from {+35}Al |b{+-} decay, unless otherwise  
 35SI3cL noted.                                                                 
 35SI cL J$From shell mode predictions and systematic trends on Si isotopes     
 ...
 35SI2 L MOMM1=(-)1.638 4 (2007Ne14,2014StZZ)                                   
 35SI cL MOMM1$Using |b-NMR on a polarized fragment beam (2007Ne14).            
 35SI cL J$(d,p)=3 in {+2}H({+34}Si,p|g), 7/2- from shell-model predictions, and
 35SI2cL systematic trends in Si isotopes.                                      
 35SI cL T$From |b-decay measurement (1988DuZT). In an earlier paper by the same
 35SI2cL group (1986Du07) value given is 0.87 s {I17}. The evaluators adopt the 
 35SI3cL more recent value.                                                     
 ...
 35SI cL $Configuration=|nf{-7/2}.                                              
 35SI  L 909.95    23 (3/2)-           55 PS     14                             
 35SIX L XREF=ABCDE                                                             
 35SI cL T$from ({+36}Si,{+35}Si|g)                                             
 35SI cL J$L(d,p)=1 in {+2}H({+34}Si,p|g), 3/2- from shell-model predictions,   
 35SI2cL and systematic trends in Si isotopes.                                  
 35SI cL T$From analysis of broadened lineshape in {+9}Be({+36}Si,{+35}Si|g)    
 35SI2cL (2014St18).                                                            
 35SI cL $Configuration=|np{-3/2}.                                              
 35SI  G 910.11    30 100      [E2]                                             
 35SI cG E$others: 910 {I3} from ({+34}Si,p|g) and 908 {I4} from                
 35SI2cG ({+36}Si,{+35}Si|g).                                                   
 35SI  L 973.88    18 (3/2+)           5.9 NS    6                              
 35SIX L XREF=AE                                                                
 35SI cL T$from {+35}Al |b{+-} decay (38.1 ms).                                 
 35SI cL T$From the time spectrum of delayed coincidences in {+35}Al |b{+-}     
 35SI2cL decay (2001Nu01).                                                      
 35SI  G 64.1      3 100       [E1]                                             
 35SIB G BE1W=0.00036 4                                                         
 35SIS G KC=0.0342 7$LC=0.00244 5$MC=0.000158 4                                 
 35SI  G 973.78    20 11.8   24 [M2]                                            
 35SIB G BM2W=0.059 14                                                          
 35SI  L 1689      3  1/2+                                                      
 35SIX L XREF=E                                                                 
 35SI cL J$L(n)=0 in {+9}Be({+36}Si,{+35}Si|g).                                 
 35SI  G 715       4 14.6    16                                             A   
 35SI  G 780       4 100.0   77                                             A   
 35SI  L 1970      6                                                            
 35SIX L XREF=E                                                                 
 35SI  G 1970      6 100                                                    B   
 35SI  L 2044      5  (1/2)-                                                    
 35SIX L XREF=DE                                                                
 35SI cL J$L(d,p)=1 in {+2}H({+34}Si,p|g), 1/2- from shell-model predictions.   
 35SI cL $Configuration=|np{-1/2}.                                              
 35SI  G 1134      5 100                                                    B   
 35SI cG E$from ({+36}Si,{+35}Si|g). Other: 1134 {I6} from ({+34}Si,p|g)        
 35SI  L 2168.2    4  5/2+                                                      
 35SIX L XREF=AE                                                                
 35SI cL J$corresponding to an IAR in {+35}P with L(p)=2 and J=5/2+ from        
 35SI2cL R-Matrix analysis in {+1}H({+34}Si,p):From IAR (2012Im01).             
 35SI  G 1194.2    4 35.3    80                                                 
 35SI  G 2168.2    6 100     20                                                 
 35SI cG E$other: 2164 {I6} from ({+36}Si,{+35}Si|g).                           
 35SI cG RI$from {+35}Al |b{+-} decay (38.1 ms).                                
 35SI  L 2275      6                                                            
 35SIX L XREF=E                                                                 
 35SI  G 2275      6 100                                                    B   
 35SI  L 2377      7                                                            
 ...
 35SI  L 5500      AP (5/2)-                                                    
 35SIX L XREF=D                                                                 
 35SI cL J$L(d,p)=3 in {+2}H({+34}Si,p|g).                                      
 35SI cL $Configuration=|nf{-5/2}.                                              
 35SI  L 5760                                                                   
 35SIX L XREF=A                                                                 
 35SI  L 6330                                                                   
 35SIX L XREF=A                                                                 
