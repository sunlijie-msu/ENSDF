...
`T$from lifetime |t=ADOPTED UNIT {IUNC} (NSR1, METHOD1). Other: LIMIT UNIT (NSR2, METHOD2).`

## Standard Rules

### Formatting and Grammar
*   **Single Line**: Do not insert manual line breaks.
...
*   **Multiple Others**: `T$lifetime |t=4.5 ps {I5} (2021Vi01). Others: >3 ps (1970Br10), 4.2 ps {I10} (1968An02).`
