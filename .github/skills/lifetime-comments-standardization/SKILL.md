...
*   **Rule for T$ comments**: Use "lifetime |t=" when referring to the lifetime value and omit "lifetime |t=" for half-life references because the T comments already indicate half-life.
*   If τ and T₁/₂ mixed in a comment, convert τ to T₁/₂ using T₁/₂ = τ × ln(2) ≈ 0.693 × τ.
