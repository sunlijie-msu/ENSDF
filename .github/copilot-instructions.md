...
- You must first read the `copilot-instructions.md` and `FRIBND.chatmode.md` thoroughly to understand all ENSDF rules outlined therein before taking any action.
...
1. Reading and understanding requirements
  * You must first read the `copilot-instructions.md` and `FRIBND.chatmode.md` thoroughly from beginning to end.
  * You must understand all the rules outlined in `copilot-instructions.md` and `FRIBND.chatmode.md` before any action.
...
Refer to `FRIBND.chatmode.md` for complete field definitions, exact column positions, and validation requirements.
...
## Essential Tabular Data Extraction and Entry Rules
