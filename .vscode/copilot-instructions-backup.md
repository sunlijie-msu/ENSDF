...
### Change Detection (Multi-Tool Approach)
...
- [ ] Run `git status` - check all modified files
...
Enhanced Tools:
- tool_name.py: Specific improvements

ENSDF Content Improvements:
- file_name.ens: Specific changes with line numbers
